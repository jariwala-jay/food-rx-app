...
const Map<String, List<Map<String, dynamic>>> commonOtherPantryItems = {
  ...
  'dairy_eggs': [
    {
      'name': 'Greek Yogurt',
      'id': 'greek-yogurt',
      'imageAsset': 'assets/pantry_ingredients/greek_yogurt.png',
    },
    {
    ...
    },
    {
      'name': 'Swiss Cheese',
      'id': 'swiss-cheese',
      'imageAsset': 'assets/pantry_ingredients/swiss_cheese.png',
    },
    {
      'name': 'Heavy Cream',
      'id': 'heavy-cream',
  ...
  'protein_meat': [
    ...
    },
    {
      'name': 'Ground Turkey',
      'id': 'ground-turkey',
      'imageAsset': 'assets/pantry_ingredients/ground_turkey.png',
    },
    {
      'name': 'Salmon Fillet',
      'id': 'salmon-fillet',
  ...
  'frozen_foods': [
    ...
    },
    {
      'name': 'Frozen Pizza',
      'id': 'frozen-pizza',
      'imageAsset': 'assets/pantry_ingredients/frozen_pizza.png',
    },
    {
      'name': 'Ice Cream',
      'id': 'ice-cream',
    ...
    },
    {
      'name': 'Frozen Waffles',
      'id': 'frozen-waffles',
      'imageAsset': 'assets/pantry_ingredients/frozen_waffles.png',
    },
  ],
  'snacks_beverages': [
    {
    ...
    },
    {
      ...
      'id': 'granola-bars',
      'imageUrl':
          'https://spoonacular.com/cdn/ingredients_100x100/granola.jpg'
    },
    {
      'name': 'Pretzels',
      'id': 'pretzels',
