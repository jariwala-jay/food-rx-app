...
class NotificationTestingPage extends StatefulWidget {
  ...
  @override
  State<NotificationTestingPage> createState() => _NotificationTestingPageState();
}
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTestSection(
              'Health Goal Notifications',
              [
                _buildTestButton('Test Progress Milestones', _testProgressMilestones),
                _buildTestButton('Test Streak Achievements', _testStreakAchievements),
                _buildTestButton('Test Goal Completions', _testGoalCompletions),
                _buildTestButton('Test Motivation Notifications', _testMotivationNotifications),
            ...
            _buildTestSection(
              'System Notifications',
              [
                _buildTestButton('Test Onboarding Status', _testOnboardingStatus),
            ...
            _buildTestSection(
              'Pantry Notifications',
              [
                _buildTestButton('Test Expiration Alerts', _testExpirationAlerts),
                _buildTestButton('Test Low Stock Alerts', _testLowStockAlerts),
                _buildTestButton('Test Recipe Suggestions', _testRecipeSuggestions),
              ],
            ),
            ...
            _buildTestSection(
              ...
              [
                ...
                _buildTestButton('Clear All Notifications', _clearAllNotifications),
              ],
            ),
